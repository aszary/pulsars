...
from database.models import Pulsar, XrayArticle, XrayFit, XrayComponent, Additional, Geometry, Subpulse, Calculation, GammaRayFermi
...
admin.site.register(GammaRayFermi)
