...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GammaRayFermi'
        db.create_table(u'database_gammarayfermi', (
            ...
            ('lum_plus_dist', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('lum_minus_dist', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'database', ['GammaRayFermi'])


    def backwards(self, orm):
        # Deleting model 'GammaRayFermi'
        db.delete_table(u'database_gammarayfermi')
