...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field gammarays on 'Pulsar'
        db.create_table(u'database_pulsar_gammarays', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pulsar', models.ForeignKey(orm[u'database.pulsar'], null=False)),
            ('gammarayfermi', models.ForeignKey(orm[u'database.gammarayfermi'], null=False))
        ))
        db.create_unique(u'database_pulsar_gammarays', ['pulsar_id', 'gammarayfermi_id'])


    def backwards(self, orm):
        # Removing M2M table for field gammarays on 'Pulsar'
        db.delete_table('database_pulsar_gammarays')
    ...
    models = {
        ...
        u'database.gammarayfermi': {
            'Meta': {'object_name': 'GammaRayFermi'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'lum_minus_dist': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'lum_plus': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'lum_plus_dist': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'num': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'database.pulsar': {
            ...
            'gammarays': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['database.GammaRayFermi']", 'symmetrical': 'False'}),
