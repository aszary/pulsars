...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pulsar.Units'
        db.add_column(u'database_pulsar', 'Units',
        ...
        # Changing field 'Pulsar.Date'
        db.alter_column(u'database_pulsar', 'Date', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Pulsar.Units'
        db.delete_column(u'database_pulsar', 'Units')
        ...
        # Changing field 'Pulsar.Date'
        db.alter_column(u'database_pulsar', 'Date', self.gf('django.db.models.fields.FloatField')())
