...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'XrayFit.importance'
        db.delete_column(u'database_xrayfit', 'importance')

        # Adding field 'XrayFit.num'
        db.add_column(u'database_xrayfit', 'num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'XrayComponent.num'
        db.add_column(u'database_xraycomponent', 'num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'XrayArticle.importance'
        db.delete_column(u'database_xrayarticle', 'importance')

        # Adding field 'XrayArticle.num'
        db.add_column(u'database_xrayarticle', 'num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'XrayFit.importance'
        db.add_column(u'database_xrayfit', 'importance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'XrayFit.num'
        db.delete_column(u'database_xrayfit', 'num')

        # Deleting field 'XrayComponent.num'
        db.delete_column(u'database_xraycomponent', 'num')

        # Adding field 'XrayArticle.importance'
        db.add_column(u'database_xrayarticle', 'importance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'XrayArticle.num'
        db.delete_column(u'database_xrayarticle', 'num')
