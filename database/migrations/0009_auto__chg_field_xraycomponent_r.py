...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XrayComponent.r'
        db.alter_column(u'database_xraycomponent', 'r', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'XrayComponent.r'
        db.alter_column(u'database_xraycomponent', 'r', self.gf('django.db.models.fields.FloatField')())
