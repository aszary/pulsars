...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Calculation.num'
        db.add_column(u'database_calculation', 'num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Geometry.num'
        db.add_column(u'database_geometry', 'num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Additional.num'
        db.add_column(u'database_additional', 'num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subpulse.num'
        db.add_column(u'database_subpulse', 'num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Calculation.num'
        db.delete_column(u'database_calculation', 'num')

        # Deleting field 'Geometry.num'
        db.delete_column(u'database_geometry', 'num')

        # Deleting field 'Additional.num'
        db.delete_column(u'database_additional', 'num')

        # Deleting field 'Subpulse.num'
        db.delete_column(u'database_subpulse', 'num')
