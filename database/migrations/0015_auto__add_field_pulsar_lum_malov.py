...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pulsar.lum_malov'
        db.add_column(u'database_pulsar', 'lum_malov',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pulsar.lum_malov'
        db.delete_column(u'database_pulsar', 'lum_malov')
    ...
    models = {
        ...
        u'database.pulsar': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lum_malov': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
